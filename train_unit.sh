...
fairseq-train --fp16 $exp_name/bin \
    ...
    --lr-scheduler polynomial_decay --lr 0.0005 --total-num-update $total_num_update --warmup-updates $warmup_update \
    ...
    --ddp-backend legacy_ddp --wandb-project $exp_name --fp16