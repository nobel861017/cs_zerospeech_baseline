...
python scripts/tokenize_data.py --input $text_dir/test_cs_es-en.csv --output $output_dir/test_total/es-en/ 
python scripts/tokenize_data.py --input $text_dir/test_cs_fr-en.csv --output $output_dir/test_total/fr-en/
python scripts/tokenize_data.py --input $text_dir/test_cs_zh-en.csv --output $output_dir/test_total/zh-en/
